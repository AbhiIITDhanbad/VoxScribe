...
from SpeechToText.components.data_ingestion import DataIngestion
from SpeechToText.components.data_preprocessing import DataPreprocessing
from SpeechToText.components.model_trainer import ModelTrainer
from SpeechToText.components.model_evaluation import ModelEvaluation
from SpeechToText.components.model_pusher import ModelPusher
from SpeechToText.entity.config_entity import DataIngestionConfig, DataPreprocessingConfig, ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig
from SpeechToText.entity.artifact_entity import DataIngestionArtifacts, DataPreprocessingArtifacts, ModelTrainerArtifacts, ModelEvaluationArtifacts, ModelPusherArtifacts
...
class TrainingPipeline:
    ...
    def start_data_preprocessing(self, data_ingestion_artifacts: DataIngestionArtifacts) -> DataPreprocessingArtifacts:
        ...
        try: 
            data_preprocessing = DataPreprocessing(data_preprocessing_config=self.data_preprocessing_config, data_ingestion_artifacts=data_ingestion_artifacts)
    ...
    def start_model_training(self, data_preprocessing_artifacts: DataPreprocessingArtifacts) -> ModelTrainerArtifacts:
        ...
        try: 
            ...
            model_trainer = ModelTrainer(model_trainer_config=self.model_trainer_config, data_preprocessing_artifacts=data_preprocessing_artifacts)
