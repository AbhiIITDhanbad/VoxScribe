...
class DataPreprocessingConfig:
    ...
    wavs_file_path: str = os.path.join(metadata_dir_path, WAVS_FILE_PATH)
    train_dir_path: str = os.path.join(data_preprocessing_artifacts_dir, DATA_PREPROCESSING_TRAINING_DIR)
